...
%token UNIT LPAREN RPAREN LBRACE RBRACE LBRACK RBRACK DBL_QUOTE SNG_QUOTE
...
let_decl:
  | typ ID ASSIGN expr SEMI                 { ConstDecl((Bind(Immutable, $1, $2), $4)) }
...
gn_call:
  | id_ns LPAREN actuals RPAREN             { Call($1, $3) }
  | UNIT                                    { Unit }
...
fn_op:
  | MAP                                     { Map }
  | FILTER                                  { Filter } /* TODO: better syntax? */
